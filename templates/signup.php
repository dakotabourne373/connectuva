            ...
            <div class="col-4">
                ...
                <form action="signup.php" method="post">
                    <div class="mb-3">
                        ...
                        <input required type="email" class="form-control" id="email" name="email" pattern="[a-z][a-z][a-z]?[0-9][a-z][a-z]?[a-z]?@virginia.edu" placeholder="computingID@virginia.edu"/>
                    </div>
                    <div class="mb-3">
