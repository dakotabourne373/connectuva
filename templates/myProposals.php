...
<head>
    ...
    <meta name="description" content="The Proposals you have created for connect uva">
...
<body>
    ...
    <div class="container landing">
        Here is the page where you can find all of the Projects you have created. Whether you are a student or a faculty member,
        this page will aggregate everything you post into one easy to find list, so you never have to go looking around for your 
        projects.<br><br>
    ...
    <script type="text/javascript">
        let url = "<?=$this->url?>api/myProposalList";
        var rowURL = "<?php echo $this->url; ?>";

        $.get(url, function (data, status) {
            if(data.length === 0){
                $("div.container").append($("<div class='alert alert-danger'>It doesn't seem like you have created any projects or proposals!</div>"));
                return;
            }
